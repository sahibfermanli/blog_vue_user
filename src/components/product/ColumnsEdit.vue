...
let selectedColumns = computed(() => store.getters['packageColumns/GET_SELECTED_COLUMNS'])
let columns = computed(() => store.getters['packageColumns/GET_COLUMNS'])
...
const saveColumns = () => {
  ...
  store.dispatch('packageColumns/SAVE_COLUMNS', { columns, selectedKeys })
}
const closeDialog = () => {
