    ...
    <div class="offcanvas-content pr-5 mr-n5">
      ...
      <div class="d-flex align-items-center mt-5">
        <div class="symbol symbol-120 mr-5 symbol-light-success">
          <span class="symbol-label font-size-h1 font-weight-bold">{{ getNameFirstLetter() }}</span>
        </div>
        <div class="d-flex flex-column">
          ...
          >
            {{ $store.getters['auth/GET_USER']?.name }} {{ $store.getters['auth/GET_USER']?.surname }}
          </a>
          <div class="navi mt-2">
            <a
              href="#"
...
const show = computed(() => store.getters['theme/GET_USER_PANEL'])
